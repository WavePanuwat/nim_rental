...
export interface InvoiceDetail {
  id: string; // Link to RentalProcessDetail.id
  cycle: string;
  contractNo: string;
  docDate: string;
  property: string;
...
// ----------------------------------------------------------------------
// 2. Mock Data: รายละเอียดแยกตาม ID (Details Map)
// ----------------------------------------------------------------------
...
// ----------------------------------------------------------------------
// 3. Mock Data: รายละเอียดใบแจ้งหนี้ (Invoice Detail Map)
// ----------------------------------------------------------------------
...
const INVOICE_DETAILS_BY_ID: Record<string, InvoiceDetail> = {
    ...
    '102': {
        ...
        tenant: "วิภาวดี รังสิต", address: "44/2 ถ.วิภาวดี จตุจักร กทม.", note: "-", status: 'CONFIRM', totalAmount: 5520.00,
        items: [
            { id: 1, description: "ค่าเช่า", serialNo: "", effectiveDate: "01/01/2569 - 31/01/2569", amountBeforeTax: 5000, tax: 0, wht: 0, total: 5000, note: "" },
    ...
    '103': {
        ...
        tenant: "ปิยะพงษ์ ผิวอ่อน", address: "88 หมู่บ้านนักกีฬา สะพานสูง กทม.", note: "-", status: 'CONFIRM', totalAmount: 4950.00,
        items: [
    ...
    '104': { // (ห้องตามตัวอย่างรูปภาพ)
        ...
        tenant: "สิปกร นัดดาครี", address: "409 ม.1 ตำบลขุนยวม อำเภอขุนยวม จังหวัด แม่ฮ่องสอน", note: "-", status: 'CONFIRM', totalAmount: 3266.43,
        items: [
    ...
    '105': {
        ...
        tenant: "บัวขาว บัญชาเมฆ", address: "55/5 หมู่ 5 ต.บ้านดู่ อ.เมือง จ.เชียงราย", note: "-", status: 'CONFIRM', totalAmount: 7000.00,
        items: [
    ...
    '203': {
        ...
        tenant: "ชูใจ ใฝ่เรียน", address: "-", note: "รอจดมิเตอร์", status: 'PENDING', totalAmount: 3500.00,
        items: [
            { id: 1, description: "ค่าเช่า", serialNo: "", effectiveDate: "01/01/2569 - 31/01/2569", amountBeforeTax: 3500, tax: 0, wht: 0, total: 3500, note: "" },
        ]
    },
    ...
    '302': {
        ...
        tenant: "วีระ กล้าหาญ", address: "111 ถ.เพชรเกษม กทม.", note: "รอบบิลธันวาคม", status: 'CONFIRM', totalAmount: 4570.00,
        items: [
            { id: 1, description: "ค่าเช่า", serialNo: "", effectiveDate: "01/12/2568 - 31/12/2568", amountBeforeTax: 4000, tax: 0, wht: 0, total: 4000, note: "" },
...
// ----------------------------------------------------------------------
// 1. Mock Data: รายการหลัก (Main List)
// ----------------------------------------------------------------------
